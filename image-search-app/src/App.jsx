...
useEffect(() => {
  ...
  return (
    <div className="App">
      ...
      {loading ? <h1 className='text-2xl font-bold text-center'>Loading...<span className="loading loading-spinner loading-xl"></span></h1> :<div className="flex justify-center align-items-center m-20 ml-48 mt-10 grid grid-cols-3 gap-4 ">
        {images.map((image) => {
